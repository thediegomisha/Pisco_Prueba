...
Public Class MantoTitulo
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        If txttitulo.Text <> Nothing Then

            Try
                If conexion.State = ConnectionState.Closed Then
                    conexion.Open()
                End If
                comando = New MySqlCommand("INSERT INTO titulo (nombre)" & Chr(13) & "VALUES(@nombre)", conexion)
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            conectar()
            comando = New MySqlCommand("delete from titulo WHERE idtitulo='" & DataGridView1.Item(0, i).Value & "' ", conexion)
            comando.ExecuteNonQuery()
            mostrarlistado()
